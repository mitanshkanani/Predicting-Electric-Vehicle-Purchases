...
Controlled experiment — replace the fixed source-recipe XGBoost base margin with a nested competition-learned logistic prior while keeping the current exact-frequency feature set fixed.
...
def main() -> None:
    ...
    print("=" * 88)
    print("XGBOOST m=2 + EXACT FREQUENCY + LEARNED LOGISTIC BASE-MARGIN EXPERIMENT")
    print("=" * 88)
    ...
    print("HYPOTHESIS:")
    print(
        "  The fixed original-dataset recipe base margin helped, but the "
        "competition distribution is only similar to the source dataset. "
        "Learning the same smooth four-variable prior directly from competition "
        "training data may provide a better residual starting point for XGBoost."
    )
    print()
    print("ONLY CHANGE:")
    print(
        "  Replace the FIXED source-recipe base margin with a nested, "
        "competition-learned logistic base margin using only:"
    )
    print("    - Annual_Income_USD")
    ...
    for outer_fold in range(5):
        ...
        print(
            ...
            f"+learned_margin={candidate_fold_auc:.8f} "
    ...
    if (
        ...
        decision = "KEEP_LEARNED_LOGISTIC_BASE_MARGIN"
    else:
        decision = "REJECT_LEARNED_LOGISTIC_BASE_MARGIN"

    summary_lines = [
        "EXPERIMENT: XGBOOST m=2 + EXACT FREQUENCY + LEARNED LOGISTIC BASE MARGIN",
        "=" * 78,
        "",
        "HYPOTHESIS",
        "Can a competition-learned smooth four-variable logistic prior outperform",
        "the fixed source-recipe base margin as XGBoost's residual starting point?",
        "",
        "ONLY CHANGE",
        "Base margin: fixed original-data recipe -> nested competition logistic prior",
        "",
        "HELD FIXED",
        "- frozen 5 folds",
    ...
    summary_lines.extend(
        [
            "",
            "EXACT-FREQUENCY FEATURE IMPORTANCE (LEARNED-MARGIN MODEL)",
        ]
    )
    ...
    print()
    print("=" * 88)
    print("EXACT FREQUENCY + LEARNED LOGISTIC BASE-MARGIN EXPERIMENT COMPLETE")
    print("=" * 88)
    ...
    print(f"+ learned base margin  : {candidate_auc:.8f}")
    ...
    print("  4. learned_logistic_margin_coefficients.csv")
