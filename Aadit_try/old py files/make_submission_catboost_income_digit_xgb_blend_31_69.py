...
Create Kaggle submission for the current locally validated champion:
    ...
    31% CatBoost 3-seed rank
    69% XGBoost m=2 + Annual_Income_USD digit-decomposition rank

LOCAL EVIDENCE
--------------
Leakage-safe meta-CV OOF:
    0.94577587

Selected CAT weights by held fold:
    [0.30, 0.32, 0.30, 0.29, 0.34]
...
It packages the already-produced test predictions into Kaggle format.

Run:
    python make_submission_catboost_income_digit_xgb_blend_31_69.py
"""
...
OUTPUT_PATH = (
    OUTPUT_DIR
    / "catboost_income_digit_xgb_rank_blend_31_69.csv"
)
...
def main() -> None:
    ...
    print("=" * 82)
    print(
        "Model: 31% CatBoost 3-seed rank "
        "+ 69% income-digit XGBoost rank"
    )
    print(
